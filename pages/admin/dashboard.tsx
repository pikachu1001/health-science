...
export default function AdminDashboard() {
  ...
  const totalAdminRevenue = subsLoading ? 0 : subscriptions.reduce((sum, s) => sum + ((s as any).adminRevenue || 0), 0);
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between h-16 items-center">
              <div className="flex items-center gap-3">
                ...
                <h1 className="text-2xl font-extrabold text-white tracking-wide drop-shadow">管理者ダッシュボード</h1>
              </div>
