...
import { FaClinicMedical, FaSignInAlt, FaArrowLeft } from 'react-icons/fa';
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-50 via-white to-purple-100">
      ...
      <header className="sticky top-0 z-20 bg-gradient-to-r from-blue-100 via-white to-blue-50 shadow-md border-b border-blue-200 flex items-center px-4 h-16">
        ...
        <span className="font-extrabold text-blue-900 text-xl">クリニックログイン</span>
      </header>
      <main className="flex-1 flex flex-col items-center justify-center py-12 px-4">
        <div className="w-full max-w-md bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl p-8 border border-blue-100">
          <div className="flex flex-col items-center mb-6">
            <FaClinicMedical className="text-blue-500 text-4xl mb-2" />
            <h2 className="text-2xl font-bold text-blue-900 mb-2">クリニックログイン</h2>
          </div>
          ...
          <div className="mt-6 flex flex-col items-center gap-2">
            <Link href="/auth/clinic/register" className="text-blue-700 hover:underline flex items-center gap-1"><FaClinicMedical /> 新規登録はこちら</Link>
