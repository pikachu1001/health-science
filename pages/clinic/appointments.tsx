          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between h-16 items-center">
              <div className="flex items-center gap-3">
                ...
                <h1 className="text-2xl font-extrabold text-white tracking-wide drop-shadow">予約一覧</h1>
              </div>
            </div>
          </div>
        </header>
        <div className="flex">
          ...
          <main className="flex-1 p-6">
            <div className="bg-white shadow rounded-lg p-8 flex flex-col items-center justify-center min-h-[300px]">
              <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold bg-blue-100 text-blue-700 mb-4">予約リスト</span>
              <div className="text-gray-500">予約データはここに表示されます（ダミー/プレースホルダー）。</div>
            </div>
          </main>
        </div>
      </div>
